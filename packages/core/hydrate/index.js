...
const NAMESPACE = 'stencil-styling';
const BUILD = /* stencil-styling */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, attachStyles: true, cloneNodeFix: false, cmpDidLoad: true, cmpDidRender: true, cmpDidUnload: false, cmpDidUpdate: false, cmpShouldUpdate: false, cmpWillLoad: true, cmpWillRender: false, cmpWillUpdate: false, connectedCallback: false, constructableCSS: false, cssAnnotations: true, cssVarShim: false, devTools: false, disconnectedCallback: false, dynamicImportShim: false, element: false, event: false, hasRenderFn: true, hostListener: false, hostListenerTarget: false, hostListenerTargetBody: false, hostListenerTargetDocument: false, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: false, hydrateClientSide: true, hydrateServerSide: true, hydratedAttribute: false, hydratedClass: true, isDebug: false, isDev: false, isTesting: false, lazyLoad: true, lifecycle: true, lifecycleDOMEvents: false, member: true, method: false, mode: false, observeAttribute: true, profile: false, prop: true, propBoolean: false, propMutable: true, propNumber: false, propString: true, reflect: true, safari10: false, scoped: false, scriptDataOpts: false, shadowDelegatesFocus: false, shadowDom: true, shadowDomShim: true, slot: true, slotChildNodesFix: false, slotRelocation: true, state: false, style: true, svg: false, taskQueue: true, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: false, vdomKey: true, vdomListener: true, vdomPropOrAttr: true, vdomRef: true, vdomRender: true, vdomStyle: true, vdomText: true, vdomXlink: true, watchCallback: true };
...
const jgBannerCss = "/*!@:host*/.sc-jg-banner-h{display:flex;font-family:Arial, Helvetica, sans-serif}/*!@:host(.banner)*/.banner.sc-jg-banner-h{height:30px;position:fixed;bottom:0;left:0;right:0;text-align:center;text-transform:uppercase;font-weight:600;align-items:center;justify-content:center}/*!@:host(.blue)*/.blue.sc-jg-banner-h{background-color:#1DA1F2;color:#FFF}";
...
const jgButtonCss = "/*!@*,\n*::before,\n*::after*/*.sc-jg-button,*.sc-jg-button::before,*.sc-jg-button::after{box-sizing:border-box}/*!@body,\nh1,\nh2,\nh3,\nh4,\np,\nfigure,\nblockquote,\ndl,\ndd*/body.sc-jg-button,h1.sc-jg-button,h2.sc-jg-button,h3.sc-jg-button,h4.sc-jg-button,p.sc-jg-button,figure.sc-jg-button,blockquote.sc-jg-button,dl.sc-jg-button,dd.sc-jg-button{margin:0}/*!@ul[role='list'],\nol[role='list']*/ul[role='list'].sc-jg-button,ol[role='list'].sc-jg-button{list-style:none}/*!@html:focus-within*/html.sc-jg-button:focus-within{scroll-behavior:smooth}/*!@body*/body.sc-jg-button{min-height:100vh;text-rendering:optimizeSpeed;line-height:1.5}/*!@a:not([class])*/a.sc-jg-button:not([class]){text-decoration-skip-ink:auto}/*!@img,\npicture*/img.sc-jg-button,picture.sc-jg-button{max-width:100%;display:block}/*!@input,\nbutton,\ntextarea,\nselect*/input.sc-jg-button,button.sc-jg-button,textarea.sc-jg-button,select.sc-jg-button{font:inherit}@media (prefers-reduced-motion: reduce){/*!@html:focus-within*/html.sc-jg-button:focus-within{scroll-behavior:auto}/*!@*,\n  *::before,\n  *::after*/*.sc-jg-button,*.sc-jg-button::before,*.sc-jg-button::after{animation-duration:0.01ms !important;animation-iteration-count:1 !important;transition-duration:0.01ms !important;scroll-behavior:auto !important}}/*!@:host*/.sc-jg-button-h{display:inline-block}/*!@.button*/.button.sc-jg-button{border:none;background:none;display:inline-flex}/*!@.button:hover*/.button.sc-jg-button:hover{cursor:pointer}/*!@.button ::slotted(svg)*/.button .sc-jg-button-s>svg{color:var(--button-hover)}";
...
class Button {
  ...
  render() {
    return (hAsync(Host, null, hAsync("button", { class: "button" }, hAsync("slot", null), this.label)));
  }
...
class InputContainer {
  ...
  render() {
    return (hAsync(Host, null, hAsync("div", { class: "focus-indicator" }, hAsync("slot", null))));
  }
  static get style() { return jgInputContainerCss; }
  static get cmpMeta() { return {
    "$flags$": 4,
    "$tagName$": "jg-input-container",
    "$members$": undefined,
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
...
const jgMenuCss = "/*!@:host*/.sc-jg-menu-h{display:block;width:320px;padding:1px;position:relative;z-index:2;box-sizing:border-box}/*!@.menu-wrapper*/.menu-wrapper.sc-jg-menu{border:1px solid black;list-style-type:none;margin:0;padding:0;border-radius:5px}/*!@.menu-wrapper li*/.menu-wrapper.sc-jg-menu li.sc-jg-menu{padding:8px 7px;display:flex;justify-content:space-between;align-items:center}";
...
class Menu {
  ...
  render() {
    return (hAsync(Host, null, hAsync("ul", { class: "menu-wrapper" }, hAsync("li", null, "Option 1"), hAsync("li", null, "Option 2"), hAsync("li", null, "Option 3"), hAsync("li", null, "Option 4"), hAsync("li", null, "Option 5"))));
  }
  get host() { return getElement(this); }
  static get style() { return jgMenuCss; }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "jg-menu",
    "$members$": {
...
var searchIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="24" height="24" viewBox="0 0 24 24"><path d="M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z" fill="currentColor" /></svg>
`;

const jgSearchBarCss = "/*!@*,\n*::before,\n*::after*/*.sc-jg-search-bar,*.sc-jg-search-bar::before,*.sc-jg-search-bar::after{box-sizing:border-box}/*!@body,\nh1,\nh2,\nh3,\nh4,\np,\nfigure,\nblockquote,\ndl,\ndd*/body.sc-jg-search-bar,h1.sc-jg-search-bar,h2.sc-jg-search-bar,h3.sc-jg-search-bar,h4.sc-jg-search-bar,p.sc-jg-search-bar,figure.sc-jg-search-bar,blockquote.sc-jg-search-bar,dl.sc-jg-search-bar,dd.sc-jg-search-bar{margin:0}/*!@ul[role='list'],\nol[role='list']*/ul[role='list'].sc-jg-search-bar,ol[role='list'].sc-jg-search-bar{list-style:none}/*!@html:focus-within*/html.sc-jg-search-bar:focus-within{scroll-behavior:smooth}/*!@body*/body.sc-jg-search-bar{min-height:100vh;text-rendering:optimizeSpeed;line-height:1.5}/*!@a:not([class])*/a.sc-jg-search-bar:not([class]){text-decoration-skip-ink:auto}/*!@img,\npicture*/img.sc-jg-search-bar,picture.sc-jg-search-bar{max-width:100%;display:block}/*!@input,\nbutton,\ntextarea,\nselect*/input.sc-jg-search-bar,button.sc-jg-search-bar,textarea.sc-jg-search-bar,select.sc-jg-search-bar{font:inherit}@media (prefers-reduced-motion: reduce){/*!@html:focus-within*/html.sc-jg-search-bar:focus-within{scroll-behavior:auto}/*!@*,\n  *::before,\n  *::after*/*.sc-jg-search-bar,*.sc-jg-search-bar::before,*.sc-jg-search-bar::after{animation-duration:0.01ms !important;animation-iteration-count:1 !important;transition-duration:0.01ms !important;scroll-behavior:auto !important}}/*!@:host*/.sc-jg-search-bar-h{display:block}";
...
class SearchBar {
  ...
  render() {
    return (hAsync(Host, { "aria-describedby": "hint" }, hAsync("jg-textfield", { ref: (el) => this.inputEl = el, onInput: (e) => this.onInput(e), value: this.value, "aria-label": "Hello", "aria-describedby": "hint" }, hAsync("jg-button", { innerHTML: searchIcon, slot: "search-submit-button", id: "search-submit-button" }), hAsync("div", { slot: "tester-slot" }, "Content from Search Bar")), this.value && (hAsync("jg-menu", { anchor: this.anchor, slot: "menu", value: this.value })), hAsync("div", { id: "hint", style: { "display": "none" } }, "This is a test")));
  }
...
const jgTextfieldCss = "/*!@*,\n*::before,\n*::after*/*.sc-jg-textfield,*.sc-jg-textfield::before,*.sc-jg-textfield::after{box-sizing:border-box}/*!@body,\nh1,\nh2,\nh3,\nh4,\np,\nfigure,\nblockquote,\ndl,\ndd*/body.sc-jg-textfield,h1.sc-jg-textfield,h2.sc-jg-textfield,h3.sc-jg-textfield,h4.sc-jg-textfield,p.sc-jg-textfield,figure.sc-jg-textfield,blockquote.sc-jg-textfield,dl.sc-jg-textfield,dd.sc-jg-textfield{margin:0}/*!@ul[role='list'],\nol[role='list']*/ul[role='list'].sc-jg-textfield,ol[role='list'].sc-jg-textfield{list-style:none}/*!@html:focus-within*/html.sc-jg-textfield:focus-within{scroll-behavior:smooth}/*!@body*/body.sc-jg-textfield{min-height:100vh;text-rendering:optimizeSpeed;line-height:1.5}/*!@a:not([class])*/a.sc-jg-textfield:not([class]){text-decoration-skip-ink:auto}/*!@img,\npicture*/img.sc-jg-textfield,picture.sc-jg-textfield{max-width:100%;display:block}/*!@input,\nbutton,\ntextarea,\nselect*/input.sc-jg-textfield,button.sc-jg-textfield,textarea.sc-jg-textfield,select.sc-jg-textfield{font:inherit}@media (prefers-reduced-motion: reduce){/*!@html:focus-within*/html.sc-jg-textfield:focus-within{scroll-behavior:auto}/*!@*,\n  *::before,\n  *::after*/*.sc-jg-textfield,*.sc-jg-textfield::before,*.sc-jg-textfield::after{animation-duration:0.01ms !important;animation-iteration-count:1 !important;transition-duration:0.01ms !important;scroll-behavior:auto !important}}/*!@:host*/.sc-jg-textfield-h{display:inline-block;border:none}/*!@:host input[type=\"text\"]*/.sc-jg-textfield-h input[type=\"text\"].sc-jg-textfield{border:0;line-height:1.5rem;padding:6px;border-radius:6px;box-shadow:none;width:100%}/*!@:host input[type=\"text\"]:focus*/.sc-jg-textfield-h input[type=\"text\"].sc-jg-textfield:focus{outline:none}/*!@:host ::slotted(jg-button) ::slotted(svg)*/.sc-jg-textfield-h .sc-jg-textfield-s>jg-button -shadowcssslotted(svg){background-color:var(--button-hover)}/*!@:host(.ic-textfield) ::slotted(div)*/.sc-jg-textfield-h.ic-textfield .sc-jg-textfield-s>div{background-color:red}";
...
class TextField {
  ...
  render() {
    return (hAsync(Host, { class: {
        ["ic-textfield"]: true
      } }, hAsync("jg-input-container", null, hAsync("input", Object.assign({ type: "text", value: this.value, onInput: (e) => this.onInput(e) }, this.inheritedAttributes)), hAsync("slot", { name: "search-submit-button" }), hAsync("div", { class: "link" }, "Link")), hAsync("slot", { name: "menu" }), hAsync("slot", { name: "tester-slot" }, "Tester Slot"), hAsync("a", { class: "link" }, "Textfield Link"), hAsync("p", null, "Paragraph", hAsync("span", null, "Span"))));
  }
  get el() { return getElement(this); }
  static get style() { return jgTextfieldCss; }
  static get cmpMeta() { return {
    "$flags$": 9,
    "$tagName$": "jg-textfield",
    "$members$": {
      "value": [1537]
    },
    "$listeners$": undefined,
